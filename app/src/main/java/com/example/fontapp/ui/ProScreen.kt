...
import com.example.fontapp.dataModel.CustomModel
import com.example.fontapp.databinding.ActivityProScreenBinding
import com.example.fontapp.other.Utils
import com.example.fontapp.reAdapter.ScrollCustomAdapter
...
class ProScreen : AppCompatActivity() {
    ...
    private var selectPrices: Int = 1
    ...
    private var bgLayoutButtonBar: java.util.ArrayList<CardView> = java.util.ArrayList()
